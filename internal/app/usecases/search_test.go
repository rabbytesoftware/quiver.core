...
func TestSearch_CatalogOnlyResult(t *testing.T) {
	...
	assert.Equal(t, domain.ArrowMedia{Icon: "icon.png", Banner: "banner.png"}, got[0].Media)
...
func TestSearch_VaultOnlyResultIsMarkedSeenAndNotInstalled(t *testing.T) {
	...
	assert.Equal(t, domain.ArrowMedia{Icon: "vicon.png", Banner: "vbanner.png"}, got[0].Media)
