...
type AsynxRuntime struct {
	...
	ReplayFn      func(ctx context.Context, aggregateID string, fromVersion int64, toVersion int64, fn asynxModels.ProjectionHandler[domainRuntime.ArrowRuntime]) error
	WaitPublishFn func()
}
