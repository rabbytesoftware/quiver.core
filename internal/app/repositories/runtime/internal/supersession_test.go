...
func TestDrainExecution_Superseded_LeavesTakeoverExecutionUntouched(t *testing.T) {
	...
	runtimeinternal.DrainExecution(
		context.Background(), exec, ns.String(), runID, domain.MethodExecute, noopMarkInstalled, axRuntime,
	)
...
func TestDrainExecution_Superseded_TakeoverExecutionStillCompletes(t *testing.T) {
	...
	superseded.close()
	runtimeinternal.DrainExecution(
		context.Background(), superseded, ns.String(), runID, domain.MethodExecute, noopMarkInstalled, axRuntime,
	)
	...
	stop.close()
	runtimeinternal.DrainExecution(
		context.Background(), stop, ns.String(), stopID, domain.MethodStop, noopMarkInstalled, axRuntime,
	)
	axRuntime.WaitPublish()
