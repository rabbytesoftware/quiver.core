...
func (r *DarwinRuntime) ExecuteWithTimeout(ctx context.Context, path string, args []string, timeoutSeconds int) (string, error) {
	// set timeout
...
func (r *DarwinRuntime) ExecuteWithEnvironment(
	ctx context.Context,
	command []string,
...
func (r *DarwinRuntime) GetProcessStatus(ctx context.Context, processID string) (string, error) {
	r.processLock.RLock()
...
func (r *DarwinRuntime) CleanupAllProcesses(ctx context.Context) error {
	var errs []error
